...
from wilfully.app import create_app
from wilfully.database import db
from wilfully.settings import DevConfig, ProdConfig
from wilfully.user.models import User

CONFIG = ProdConfig if os.environ.get('WILFULLY_ENV') == 'prod' else DevConfig
